...
- (BOOL)openReturningError:(NSError **)error {
    ...
    // 支持 DSD64/DSD128/DSD256 及其变体采样率
    if (![_inputSource readUInt32LittleEndian:&samplingFrequency error:nil] ||
        (samplingFrequency != kSFBSampleRateDSD64 && samplingFrequency != kSFBSampleRateDSD128 &&
         ...
         samplingFrequency != kSFBSampleRateDSD64Variant && samplingFrequency != kSFBSampleRateDSD128Variant &&
         samplingFrequency != kSFBSampleRateDSD256Variant)) {
